...
from model.question_model import QuizData, QuizDataSave
...
async def process_quiz_data(quiz_data: QuizDataSave):
    print('hello: ', quiz_data)
    try:
        print('print data: ',quiz_data)
